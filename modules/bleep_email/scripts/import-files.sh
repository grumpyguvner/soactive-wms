...
#  /home/activewms/public_html/modules/bleep_email/attachments - contains the files exported from Bleep server (SHESERVER)
#
...
cd /home/activewms/public_html/modules/bleep_email/attachments
