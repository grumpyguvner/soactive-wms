...
//echo "begining translate->".$text."\n";
	    ...
	    if(!$handle){
                ...
                $this->DebugMsg = "Unable to open ".$this->CallUrl;
                $this->DebugStatus = "Translation failed";
                return false;
	    }
            $contents = '';
            while (!feof($handle)) {
...
//echo "responseDetails->".$json['responseDetails']."\n";
//echo "responseStatus->".$json['responseStatus']."\n";
