...
//          $log = new phpbmsLog($message, "EDI STOCK UPDATE", NULL, $this->db);
            ...
            $this->updateLocationStock($postData["location"], $postData["plu"], $postData["quantity_remaining"], $postData["basket"], $postData["ean"]);

	}//end method --importHeader-

    function updateLocationStock($location, $plu, $newQuantity = 0, $newBasket = "", $newEAN = "") {
	//
