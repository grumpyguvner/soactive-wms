<?php
    ...
    include("include/styles_images.php");

    $thetable = new styles_images($db, "tbld:76d711ca-0412-11e1-a021-0017083b723b");
    ...
    $phpbms->cssIncludes[] = "pages/activewms/styles_images.css";
    $phpbms->jsIncludes[] = "modules/activewms/javascript/styles_image.js";
...
?><div class="bodyline">
    ...
    <div id="rightsideDiv">
        <fieldset>
                <legend>image</legend>
                <img id="thumbpic" src="/modules/activewms/styles_image.php?id=<?php echo $therecord["id"]?>&size=153" alt="<?php echo $therecord["image_name"] ?>" style="border: 1px solid black; display: block; margin: 3px;;" />
