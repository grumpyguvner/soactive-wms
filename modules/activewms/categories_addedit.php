<?php
    ...
    $thetable = new categories($db, "tbld:0257a694-fe26-11e0-be70-0017083b723b");
    ...
    $phpbms->cssIncludes[] = "pages/activewms/categories.css";
    $phpbms->jsIncludes[] = "modules/activewms/javascript/category.js";
        ...
        $theinput = new inputField("google_taxonomy",$therecord["google_taxonomy"],"google taxonomy", true, NULL, 64, 128);
        $theform->addField($theinput);
...
?><div class="bodyline">
    ...
    <div id="rightsideDiv">
        <fieldset>
                <legend>image</legend>
                <img id="thumbpic" src="/modules/activewms/categories_image.php?id=<?php echo $therecord["id"]?>&size=153" alt="<?php echo $therecord["banner_image_name"] ?>" style="border: 1px solid black; display: block; margin: 3px;;" />
    ...
    <div id="leftDiv">
        ...
        <fieldset>
            <legend>product feeds</legend>

            <p><?php $theform->showField("google_taxonomy")?></p>
            <p><span class="notes">For products assigned to the category to be displayed correctly it must be assigned a valid google taxonomy text, please see <a href="http://support.google.com/merchants/bin/answer.py?hl=en-GB&answer=160081" target="_blank">google's specification</a> and ensure you use the "Text" specification (e.g. "Clothing & Accessories > Clothing > Activewear > Active Pants" but omit the "'s).</span></p>
