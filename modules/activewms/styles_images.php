...
//				include_once("modules/activewms/include/styleimagetorecord.php");
	...
	if($displayTable->querytype!="new" and $displayTable->querytype!="edit") {
		...
		$phpbms->cssIncludes[] = "pages/activewms/styleimages.css";
		$phpbms->jsIncludes[] = "common/javascript/queryfunctions.js";
		$phpbms->topJS[] = 'xtraParamaters="backurl="+encodeURIComponent("'.$backurl.'")+String.fromCharCode(38)+"tabledefid="+encodeURIComponent("'.$reftableid.'")+String.fromCharCode(38)+"refid="+encodeURIComponent("'.$styleImage->styleid.'");';
