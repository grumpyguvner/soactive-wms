<?php
    ...
    include("include/category_overrides.php");

    $thetable = new categories($db, "tbld:1047b638-61e8-11e1-97c4-001d0923519e");
    ...
    $phpbms->jsIncludes[] = "modules/activewms/javascript/category.js";
        ...
        $theinput = new inputField("site",$therecord["site"],NULL,true,NULL,32,128);
        $theform->addField($theinput);
...
?><div class="bodyline">
    ...
    <div id="rightsideDiv">
        ...
        <fieldset id="fsAttributes">
                ...
                <p><?php $thetable->showCategoriesSelect($therecord["categoryid"]); ?></p>

    <!--            <p><?php // $thetable->showAttractiveSelect($therecord["attractiveid"]); ?></p> -->

                <p><?php $theform->showField("site")?></p>
